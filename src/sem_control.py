...
# Note: SmartSEM and Quanta class were removed in merge, since all 
# device-specific implementations are now in separate files. 
# SEM_MultiSEM below will also be moved into separate file.
