...
class ConversionMetadata:
    ...
    def create_metadata(self, current_id, current_dataset_shape, first_slice_no_of_current_dataset,
                        ov_centre_sx_sy, ov_rotation, ov_size, ov_pixel_size, slice_thickness):
        self._metadata = {self.CONVERTED_FILES: []}
        self.add_metadata_for_new_id(current_id, current_dataset_shape, first_slice_no_of_current_dataset,
                                     ov_centre_sx_sy, ov_rotation, ov_size, ov_pixel_size, slice_thickness)
    ...
    def add_metadata_for_new_id(self, current_id, current_dataset_shape, first_slice_no_of_current_dataset,
                                ov_centre_sx_sy, ov_rotation, ov_size, ov_pixel_size, slice_thickness):
        ...
        new_id_metdata = {self.OV_CENTRE_SX_SY: ov_centre_sx_sy,
                          self.OV_ROTATION: ov_rotation,
                          self.OV_SIZE: ov_size,
                          self.OV_PIXEL_SIZE: ov_pixel_size,
                          self.SLICE_THICKNESS: slice_thickness}
        self._metadata[self.CONVERTED_FILES].append(new_id_metdata)
